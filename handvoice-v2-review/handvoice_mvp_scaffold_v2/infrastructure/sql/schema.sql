...
CREATE TABLE assessment_sessions (
    ...
    CONSTRAINT uq_participant_session_number UNIQUE (participant_id, session_number)
);
...
CREATE TABLE task_instances (
    ...
    CONSTRAINT uq_session_task_repetition UNIQUE (session_id, task_code, repetition)
);
